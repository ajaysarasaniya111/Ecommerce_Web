        ...
        <div id="wrapper">
            ...
            ?>
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                        ...
                        <li>
                            <h4 class="page-title-main">Admin Registration Edit </h4>
                        </li>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="col-lg-10">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Admin Register Edit</h4>
                                        <?php
                                        ...
                                        <?php
                                            ...
                                            if(isset($_POST['edit_btn']))
                                            {
                                                ...
                                                $query = "SELECT * FROM adminreg WHERE uid='$id' ";
                                        ...
                                        <input type="hidden" name="edit_id" value="<?php echo $row['uid'] ?>">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" required parsley-type="Name" class="form-control" id="" placeholder=" Enter your Name" name="edit_username" value="<?php echo $row['username'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-8 offset-2">
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light" name="updatebtn" >Update Data</button>

...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Error Page | 500 | Internal Server Error | Unique Electronics Admin </title>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <p class="text-muted mt-2 mb-4">Unique Electronics</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="index.php" class="btn btn-danger waves-effect waves-light"><i class="fas fa-home me-1"></i> Back to Home</a>
                                </div>

                ...
                <div class="col-md-9 col-md-push-3">
                    ...
                    <div class="products-content">
                        <div class="products-wrapper">
                            ...
                            <?php
                                    $select = mysqli_query($con, "SELECT * FROM products WHERE cat='Laptop'");
                                ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-2 rounded clearfix">
                                        ...
                                        <br>
                                            ...
                                            <span class="color"><input  type="number" name="quantity" value="min='1' max='100'"></span>
